...
<body >
    ...
    <nav  class="navbar navbar-expand-lg navbar-dark bg-primary bg-gradient" id="topNavBar">
        <div style="background-color: #900C3F ;" class="container">
            <a style="background-color: #900C3F ;" class="navbar-brand" href="./">
            Petrol Station
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'customer')? 'active' : '' ?>" href="./?page=customer">Customers</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'balances')? 'active' : '' ?>" href="./?page=balances">Balances</a>
                    </li>
                    <?php endif; ?>
                    <li class="nav-item">
